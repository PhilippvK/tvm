...
#
# @tvm.tir.transform.prim_func_pass(opt_level=0)
# def _dump_tir_pass2(tir_func, _, __):
#     print("_dump_tir_pass")
#     key = "tir2"
#     if key in dumps:
#         dumps[key].append(str(tir_func))
...
#
# @tvm.tir.transform.prim_func_pass(opt_level=0)
# def _dump_tir_pass1(tir_func, _, __):
#     print("_dump_tir_pass")
#     key = "tir1"
#     if key in dumps:
#         dumps[key].append(str(tir_func))
...
#
# @tvm.tir.transform.prim_func_pass(opt_level=0)
# def _dump_tir_pass0(tir_func, _, __):
#     print("_dump_tir_pass")
#     key = "tir0"
#     if key in dumps:
#         dumps[key].append(str(tir_func))
...
# cfg = {"tir.add_lower_pass": [[3, _dump_tir_pass], [2, _dump_tir_pass2], [1, _dump_tir_pass1], [0, _dump_tir_pass0]]}
cfg = {"tir.add_lower_pass": [get_dump_tir_pass(3), get_dump_tir_pass(2), get_dump_tir_pass(1), get_dump_tir_pass(0)]}
