...
// TODO: << auf mehrere zielen aufsplitten
// TODO: use something like print indents! enter scope, use many functions for eauch section
// TODO: constant tensors (like (weights, bias) can be also passed to TVM, ignore overhead for now
// TODO: rename input/output_index to tensor_index
// TODO: rename macro_stream to ?
// TODO: get rid of malloc and memcpy as it seems to be optional!

#include "tensorflow/lite/c/builtin_op_data.h" // TODO: "" or <>?
#include "tensorflow/lite/c/common.h"
#include "tensorflow/lite/micro/kernels/micro_ops.h"

// TODO: okay nevermind, at least for the header we need C++. Conflict with TVM approach? (ending c)
...
const TfLiteIntArray tensor_dimension0_0 = { 2, { 1,10 } };
const TfLiteIntArray tensor_dimension0_1 = { 2, { 1,10 } };
const TfLiteIntArray tensor_dimension0_2 = { 2, { 1,10 } };
...
const TfLiteIntArray inputs0 = { 2, { 0, 1 } };
const TfLiteIntArray outputs0 = { 1, { 2 } };

const TfLiteAddParams opdata0 = { kTfLiteActNone, true }; // TODO: compare?

const NodeInfo_t nodeData0 = { (TfLiteIntArray*)&inputs0, (TfLiteIntArray*)&outputs0, (void*)&opdata0), /*OP_ADD*/, };
