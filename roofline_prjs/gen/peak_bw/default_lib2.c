  ...
  for (int32_t i = 0; i < 8; ++i) {
    for (int32_t k = 0; k < 7812; ++k) {
      for (int32_t j = 0; j < 4; ++j) {
        ...
        ((float*)B)[cse_var_1] = (((float*)B)[cse_var_1] + ((float*)A)[(((i * 124992) + (k * 16)) + j)]);
      }
      for (int32_t j_1 = 0; j_1 < 4; ++j_1) {
        int32_t cse_var_2 = (((i * 16) + j_1) + 4);
        ((float*)B)[cse_var_2] = (((float*)B)[cse_var_2] + ((float*)A)[((((i * 124992) + (k * 16)) + j_1) + 4)]);
      }
      for (int32_t j_2 = 0; j_2 < 4; ++j_2) {
        int32_t cse_var_3 = (((i * 16) + j_2) + 8);
        ((float*)B)[cse_var_3] = (((float*)B)[cse_var_3] + ((float*)A)[((((i * 124992) + (k * 16)) + j_2) + 8)]);
      }
      for (int32_t j_3 = 0; j_3 < 4; ++j_3) {
        int32_t cse_var_4 = (((i * 16) + j_3) + 12);
        ((float*)B)[cse_var_4] = (((float*)B)[cse_var_4] + ((float*)A)[((((i * 124992) + (k * 16)) + j_3) + 12)]);
      }
    }
  }
  return 0;
