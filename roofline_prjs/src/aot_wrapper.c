...
// Generated on: 2024-04-11 16:51:52.910386
...
// char input0_data[1000000000];
// char input0_data[10000000];
char input0_data[INPUT_SIZE];
void* inputs[] = {input0_data};
// char output0_data[1000000000];
// char output0_data[10000000];
char output0_data[OUTPUT_SIZE];
...
#define WORKSPACE_SIZE (140000)
#endif  // WORKSPACE_SIZE
