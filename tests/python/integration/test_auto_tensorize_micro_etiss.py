...
SCH_RULES_FOR_VNNI = _get_schedule_rules_for_x86(VNNI_INTRIN_PORTABLE)
...
def tune_and_test(relay_mod, data_np, weight_np, op_name, target, sch_rules, postprocs):
    ...
    relay_mod = relay_mod.with_attr("executor", executor)
    ...
    with get_rpc_runner_micro(
        ...
        with tvm.transform.PassContext(
            opt_level=3,
            config={
                "relay.backend.use_meta_schedule_dispatch": 0b11,
            },
        ):
