...
PKG_COMPILE_OPTS = -g -Wall -O2 -Wno-incompatible-pointer-types -Wno-format -mcpu=cortex-m55 -mthumb -mfloat-abi=hard -std=gnu99  # TODO
CMAKE = /opt/arm/cmake/bin/cmake
# CC = arm-none-eabi-gcc
CC = arm-none-eabi-gcc  # TODO
# AR = arm-none-eabi-ar
AR = arm-none-eabi-ar  # TODO
...
DRIVER_CMAKE_FLAGS = -DCMAKE_TOOLCHAIN_FILE=$(ETHOSU_TEST_ROOT)/arm-none-eabi-gcc.cmake \
	...
	-DCMAKE_SYSTEM_PROCESSOR=cortex-m55  # TODO

# PKG_LDFLAGS = -lm -specs=nosys.specs -static -T ${AOT_TEST_ROOT}/corstone300.ld
PKG_LDFLAGS = -lm -specs=nosys.specs -static -T ${AOT_TEST_ROOT}/spike.ld  # TODO: not required?
