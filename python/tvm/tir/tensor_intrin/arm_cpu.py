...
def get_dotprod_intrin2(in_dtype, out_dtype):
    if in_dtype == "uint8":
        instr = "udot.v4u32.v16u8"
    else:  # if in_dtype == "int8"
        instr = "sdot.v4i32.v16i8"
    ...
    def dot_prod_impl(a: T.handle, b: T.handle, c: T.handle) -> None:
        ...
        with T.block("root"):
            ...
            #     "__dp4a", A.vload([0], "int8x4"), B.vload([0], "int8x4"), T.int32(0), dtype=out_dtype
            # )
            C[0] += T.call_llvm_pure_intrin(
                T.llvm_lookup_intrinsic_id("llvm.riscv.cv.simd.sdotsp.b"),
                # T.uint32(4),
                T.uint32(3),
                T.reinterpret(A.vload([0], "int8x4"), dtype=out_dtype),
                T.reinterpret(B.vload([0], "int8x4"), dtype=out_dtype),
                T.int32(0),
                # T.bool(1),
                dtype=out_dtype,
            )
...
ARM_DOT_4x4_i8_SDOT_INTRIN2 = "dot_4x4_i8i8s32_sdot2"
...
TensorIntrin.register(ARM_DOT_4x4_i8_SDOT_INTRIN2, *get_dotprod_intrin2("int8", "int32"))
