...
@T.prim_func
def dot_product_16x4_u8i8i32_vnni_portable(
    A: T.Buffer((4,), "uint8", offset_factor=1),
    B: T.Buffer((16, 4), "int8", offset_factor=1),
    C: T.Buffer((16,), "int32", offset_factor=1),
) -> None:
...
VNNI_DOT_16x4_INTRIN_PORTABLE = "dot_16x4_vnni_portable"
...
TensorIntrin.register(
    VNNI_DOT_16x4_INTRIN_PORTABLE, dot_product_16x4_u8i8i32_desc, dot_product_16x4_u8i8i32_vnni_portable
)
