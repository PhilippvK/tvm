...
def intrin_quad_channel_convolve(tensor_w, channels, kernel_h, kernel_w, suffix):
    """Defines a RISC-V P-Extension accelerated four-channel convolution."""
...
def quad_channel_convolve_impl(tensor_w, channels, kernel_h, kernel_w, suffix):
    ...
    # #define __SXTB16_ROR8(x) __SXTB16(__ROR(x, 8))
    # #define __PKHBT16(x,y) __PKHBT(x,y,16)
    # #define __PKHTB16(x,y) __PKHTB(x,y,16)
    return textwrap.dedent(
        ...
        #define __SXTB16_ROR8(x) __rv_sunpkd831(x)
        #define __PKHBT16(x,y) __rv_pkbt16(x,y)
        #define __PKHTB16(x,y) __rv_pktb16(x,y)
        #define __SMLAD(x,y,z) __rv_kmada(z,x,y)
        #define TVMGEN_QUAD_CHANNEL_REARRANGE_SUM_DSP( \
          ...
          uint32_t tensor_v0_c31 = __SXTB16_ROR8(tensor_v0_c3210); \
          uint32_t tensor_v1_c20 = __SXTB16(tensor_v1_c3210); \
          uint32_t tensor_v1_c31 = __SXTB16_ROR8(tensor_v1_c3210); \
          \
          ...
          uint32_t kernel_v10_c1 = __SXTB16_ROR8(kernel_v1c1_v1c0_v0c1_v0c0); \
          uint32_t kernel_v10_c2 = __SXTB16(kernel_v1c3_v1c2_v0c3_v0c2); \
          uint32_t kernel_v10_c3 = __SXTB16_ROR8(kernel_v1c3_v1c2_v0c3_v0c2); \
          \
          uint32_t tensor_v10_c0 = __PKHBT16(tensor_v0_c20, tensor_v1_c20); \
          uint32_t tensor_v10_c1 = __PKHBT16(tensor_v0_c31, tensor_v1_c31); \
          uint32_t tensor_v10_c2 = __PKHTB16(tensor_v1_c20, tensor_v0_c20); \
          uint32_t tensor_v10_c3 = __PKHTB16(tensor_v1_c31, tensor_v0_c31); \
          \
