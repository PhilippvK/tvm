...
def dense_vext_compute(cfg, data, weight, bias=None, out_dtype=None):
    """Defines the V extension instructions of dense."""
...
def dense_vext_schedule(cfg, outs):
    """Schedule function for RISC-V V-Extension instructions of dense."""
