...
def conv2d_nhwc_vext(*args, **kwargs):
    ...
    args = [cfg] + args
    assert layout == "NHWC"
    conv = conv2d_nhwc_vext_compute(*args)
    sched = conv2d_nhwc_vext_schedule(cfg, [data, kernel, conv])
    return sched, [data, kernel, conv]


conv2d_nhwc_vext.template_key = "vext"
conv2d_nhwc_vext.default_data_layout = "NHWC"
conv2d_nhwc_vext.default_kernel_layout = "HWOI"


def conv2d_nhwc_vext_compute(cfg, data, kernel, strides, padding, dilation, out_dtype):
...
def conv2d_nhwc_vext_schedule(cfg, outs):
