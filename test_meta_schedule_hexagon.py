...
def generate_rules(rules=[], rfactor_max_innermost_factor=64, mlt_structure="SSRSRS", mlt_max_innermost_factor=64, unroll_max_steps=[0, 2, 4, 8, 16, 32, 64], unroll_explicit=True):
    ...
    sch_rules = [
        ...
        *([ms.schedule_rule.MultiLevelTiling(
        ...
        )] if "MultiLevelTiling" in rules else []),
        ...
        for enable_unroll in UNROLL:
            for enable_rfactor in RFACTOR:
                ...
                for rfactor_max_innermost_factor in rfactor_max_innermost_factors:
                    mlt_structures = MLT_STRUCTURE if enable_mlt else [None]
                        ...
                        for mlt_max_innermost_factor in mlt_max_innermost_factors:
                            ...
                            for unroll_max_steps in unroll_max_steps_:
                                ...
                                for unroll_explicit in unroll_explicits:
                                    ...
                                    rule_kwargs = dict(
                                        rules=enabled_rules, rfactor_max_innermost_factor=rfactor_max_innermost_factor, mlt_structure=mlt_structure, mlt_max_innermost_factor=mlt_max_innermost_factor, unroll_max_steps=unroll_max_steps, unroll_explicit=unroll_explicit
                                    )
